...
export type CancelEvent = TypedEvent<[BigNumber], { tokenId: BigNumber }>;
...
export type SpaceRemovedEvent = TypedEvent<[string], { spaceId: string }>;
...
export interface Stays extends BaseContract {
  ...
  functions: {
    ...
    getLodgingFacilityIdsByOwner(
      _owner: string,
      overrides?: CallOverrides
    ): Promise<[string[]] & { facilities: string[] }>;
